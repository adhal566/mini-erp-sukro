...
<div class="mb-6 flex items-center">
    ...
    <h3 class="text-lg font-semibold text-gray-800">Tambah Data Baru</h3>
</div>
...
<div class="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden max-w-2xl">
    <form action="{{ route('bahan-baku.store') }}" method="POST" class="p-6">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="nama_bahan" id="nama_bahan" value="{{ old('nama_bahan') }}" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 outline-none">
        ...
        <div class="grid grid-cols-2 gap-4 mb-4">
            ...
            <div>
                ...
                <input type="number" name="harga_per_satuan" id="harga_per_satuan" value="{{ old('harga_per_satuan', 0) }}" min="0" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 outline-none">
        ...
        <div class="mb-6">
            ...
            <input type="number" step="0.01" name="stok_saat_ini" id="stok_saat_ini" value="{{ old('stok_saat_ini', 0) }}" min="0" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 outline-none">
            @error('stok_saat_ini') <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span> @enderror
        </div>

        <div class="flex justify-end">
            <button type="submit" class="px-6 py-2 bg-blue-600 text-white font-medium rounded-lg shadow-sm hover:bg-blue-700 transition">Simpan Data</button>
        </div>
    </form>
</div>
@endsection
